...
export default function ContactCard({ name, jobTitle, phone, email }) {
    return (
        <div className="rounded-xl border-2 border-[#5c5eaa] bg-[#a3a5d2] p-4 w-full max-w-xl">
            ...
            <div className="space-y-3">
                <div className="flex items-center gap-2">
                    <PhoneIcon/>
                    <span className="text-[#353767] font-medium xl:text-[20px]">{phone}</span>
                </div>
                <div className="flex items-center gap-2">
                    <EmailIcon/>
                    <span className="text-[#353767] font-medium break-all xl:text-[20px]">{email}</span>
                </div>
            </div>
        </div>
    );
