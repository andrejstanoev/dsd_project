    ...
    return (
        ...
        <div className="w-[1440px] h-[950px] top-[-90px] relative">
            ...
            <div className="w-[1440px] h-[464px] absolute top-[340px] left-0">
                <div
                    className="relative w-full max-w-full sm:max-w-[calc(100vw-8rem)] 2xl:h-[720px] h-[520px] mx-auto overflow-hidden rounded-xl shadow-lg h-full absolute bg-[#a3a5d2] rounded-[15px] border-[3px] border-[#5c5eaa]" />
