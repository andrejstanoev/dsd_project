...
const Footer = () => {
   return(
       ...
       <div
           ...
           {/*call ikona*/}
           <Link to="/kontakt">
           <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 256 256" title="075 263 678"
                className="bg-[#f5c144] lg:w-[50px] lg:h-[50px] xl:w-[55px] xl:h-[55px] transition-transform duration-300 hover:scale-105 hover:bg-[#FFD75A] rounded-full p-1"
           >
               <path fill="#353767"
           ...
           <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 512 512"
                className="bg-[#f5c144] lg:w-[50px] lg:h-[50px] xl:w-[55px] xl:h-[55px] rounded-full p-1 transition-transform duration-300 hover:scale-105 hover:bg-[#FFD75A]"
           >
